    ...
    while(True):
        ...
        for iteration in tqdm(range(episodes)):
            ...
            if(iteration%1000==0 and False):
                ...
                agent1.saveAvgPolicy("./trainedModels/kuhn/paramTesting/model9/agent1_iteration_{iteration}.pt".format(iteration=iteration))
                agent2.saveAvgPolicy("./trainedModels/kuhn/paramTesting/model9/agent2_iteration_{iteration}.pt".format(iteration=iteration))
